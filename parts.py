...
class TopFrame(ttk.LabelFrame):
    def __init__(self, master, **kwargs):
        ...
        # using ttk.sytle to change the style of the self widget
        ttkStyle = ttk.Style()
...
class MedianFrame(ttk.LabelFrame):
    def __init__(self, master, **kwargs):
        ...
        #ttk.Style change ttk.Raiobbutton shape
        self.window = master
        ttkStyle = ttk.Style()
    ...
    def radioEvent(self):
        self.window.radioButtonEventOfMedianFrame(self.radioStringVar.get())
